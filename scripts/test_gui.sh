...
if [ ! -f "$BUILD_DIR/Im8086" ]; then
    echo "Error: Executable not found at $BUILD_DIR/Im8086"
...
echo "   ./Im8086 --gui"
timeout 10s ./Im8086 --gui 2>&1 | head -20
echo ""
echo "2. Testing with software rendering (fallback):"
echo "   LIBGL_ALWAYS_SOFTWARE=1 ./Im8086 --gui"
timeout 10s env LIBGL_ALWAYS_SOFTWARE=1 ./Im8086 --gui 2>&1 | head -20
echo ""
echo "3. Testing with Mesa debug info:"
echo "   MESA_DEBUG=1 ./Im8086 --gui"
timeout 10s env MESA_DEBUG=1 ./Im8086 --gui 2>&1 | head -20
echo ""
echo "4. Testing with legacy OpenGL:"
echo "   MESA_GL_VERSION_OVERRIDE=2.1 ./Im8086 --gui"
timeout 10s env MESA_GL_VERSION_OVERRIDE=2.1 ./Im8086 --gui 2>&1 | head -20
echo ""
echo "=== Test Complete ==="
echo ""
